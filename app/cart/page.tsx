...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 py-16" style={{ paddingLeft: '5%', paddingRight: '5%' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-primary mb-8">{t('title')}</h1>
          <p className="text-gray-600 text-xl mb-8">{t('emptyCart')}</p>
          <Link href="/">
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8" style={{ paddingLeft: '5%', paddingRight: '5%' }}>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Cart Table Header */}
        <div className="bg-primary text-white py-4 px-6 rounded-t-lg grid grid-cols-12 gap-4 font-semibold">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold text-primary text-center mb-6">{t('confirmDetails')}</h2>

          <div className="grid md:grid-cols-3 gap-6">
            {/* Coupon Code */}
            <div>
              <label className="block font-semibold text-primary mb-2">{t('couponCode')}:</label>
              <input
                type="text"
                value={couponCode}
            ...
            {/* Delivery Info */}
            <div>
              <label className="block font-semibold text-primary mb-2">{t('delivery')}:</label>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="border-t-2 border-primary pt-3 mt-3">
                  <div className="flex justify-between text-primary">
                    ...
                    <span className="font-bold text-2xl">{tc('currency')} {grandTotal.toLocaleString()}.00</span>
                  </div>
                </div>
              </div>
